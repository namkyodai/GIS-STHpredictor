...
def run(parameterContainer):
    ...
    for t in range(time):
        ...
        fieldDef = osgeo.ogr.FieldDefn("H_n_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("H_l_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("H_m_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("H_h_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("HW_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        #define the field for T.trichiura
        fieldDef = osgeo.ogr.FieldDefn("T_n_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("T_l_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("T_m_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("T_h_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("Tt_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        #define the field for A.lumbricoides
        fieldDef = osgeo.ogr.FieldDefn("A_n_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("A_l_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("A_m_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("A_h_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        fieldDef = osgeo.ogr.FieldDefn("Al_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
        #for anySTH
        fieldDef = osgeo.ogr.FieldDefn("STH_3_"+str(t), osgeo.ogr.OFTString)
        fieldDef.SetWidth(5)
        layer.CreateField(fieldDef)
